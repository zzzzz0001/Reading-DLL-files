...
namespace Main_executable
{
    class Program
    {
        ...
        {
            //CHANGE THESE BELOW 3 VARIABLE VALUES ACCORDING TO YOUR SYSTEM (BUID IT WITH VISUAL STUDIO)
            ...
            string final_path = path_of_project + @"Reading Dll files\Dll Generator\bin\" + ((built_using_release == true) ? @"Release\net" : @"Debug\net") + dotnet_sdk_version + @".0\Dll Generator.dll";
            
            var classes = GetIClass1(final_path);

            Console.WriteLine(final_path);

            //var classes = GetIClass1(@"C:\Users\Roshan\Desktop\to github\Reading Dll files\Dll Generator\bin\Debug\net5.0\Dll Generator.dll");
